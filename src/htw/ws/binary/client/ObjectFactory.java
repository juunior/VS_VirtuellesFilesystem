...
public class ObjectFactory {
    ...
    private final static QName _UploadResponse_QNAME = new QName("http://server.binary.ws.htw/", "uploadResponse");
    private final static QName _Download_QNAME = new QName("http://server.binary.ws.htw/", "download");
    private final static QName _DownloadResponse_QNAME = new QName("http://server.binary.ws.htw/", "downloadResponse");
    private final static QName _Upload_QNAME = new QName("http://server.binary.ws.htw/", "upload");
     ...
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.htw/", name = "uploadResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.htw/", name = "download")
     ...
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.htw/", name = "downloadResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.htw/", name = "upload")
